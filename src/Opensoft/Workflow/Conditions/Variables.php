<?php
/**
 * File containing the Variables class.
 *
 ...
 * @version //autogen//
 */
class Variables implements ConditionInterface
{
    /**
     ...
     */
    public function __construct( $variableNameA, $variableNameB, ConditionInterface $condition )
    {
        if ( !$condition instanceof Comparison )
        {
            throw WorkflowException::propertyBaseValue('condition', $condition, 'Comparison');
        }
