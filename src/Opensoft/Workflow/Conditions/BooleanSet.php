<?php
/**
 * File containing the BooleanSet class.
 *
 ...
 * @version //autogen//
 */
abstract class BooleanSet implements ConditionInterface
{
    /**
     * Array of ConditionInterfaces
     *
     * @var array
     */
     ...
     *
     * The format of $conditions must be array( ConditionInterface )
     *
        ...
        foreach ( $conditions as $condition )
        {
            if ( !$condition instanceof ConditionInterface )
            {
                throw new \InvalidArgumentException(
                  'Array does not contain (only) ConditionInterface objects.'
                );
            }
