<?php
/**
 * File containing the InvalidInputException class.
 *
 ...
 * @version //autogen//
 */
class InvalidInputException extends ExecutionException
{
    /**
    ...
    public function __get( $propertyName )
    {
        ...
        throw new \InvalidArgumentException( $propertyName ); // todo fix exception
    }
    ...
    public function __set( $propertyName, $val )
    {
        ...
        {
            case 'errors':
                throw Exception::propertyReadOnly($propertyName);
        }
