<?php
/**
 * File containing the AbstractNodeBranch class.
 *
 ...
 * @version //autogen//
 */
abstract class NodeBranch extends Node
{
    /**
     ...
     *                 and false otherwise
     */
    protected function activateOutgoingNodes(Execution $execution, array $nodes)
    {
