<?php
/**
 * File containing the AbstractNodeMerge class.
 *
 ...
 * @version //autogen//
 */
abstract class NodeMerge extends Node
{
    /**
     ...
     */
    protected function prepareActivate(Execution $execution, $threadId = 0)
    {
     ...
     *                 and false otherwise
     */
    protected function doMerge(Execution $execution)
    {
