...
use Opensoft\Workflow\Nodes\NodeArithmeticBase;

/**
 * Adds a workflow variable together with another variable or a constant value.
 *
 * An object of the Add class adds a given operand, either a constant
 ...
 * @version //autogen//
 */
class Add extends NodeArithmeticBase
{
    /**
