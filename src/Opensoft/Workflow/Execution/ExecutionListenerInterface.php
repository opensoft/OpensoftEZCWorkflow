<?php
/**
 * File containing the ExecutionListenerInterface interface.
 *
 ...
 * @version //autogen//
 */
interface ExecutionListenerInterface
{
    /**
     ...
     * @param int $type
     */
    public function notify( $message, $type = ExecutionListenerInterface::INFO );
}
